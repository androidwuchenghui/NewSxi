package wu.chengsiyi.com.constant;
...
//    public static final String ACTION_CHARACTER_CHANGED = "action.character_changed";
    ...
    public static final UUID C_UUID_Character_Device_CustomerID=UUID.fromString("0000ff96-0000-1000-8000-00805f9b34fb");
    public static final UUID C_UUID_Character_Device_CommBaudRate=UUID.fromString("0000ff93-0000-1000-8000-00805f9b34fb");
    public static final UUID C_UUID_Character_Password_C1=UUID.fromString("0000ffc1-0000-1000-8000-00805f9b34fb");
    ...
    public static String getStatusText(int status) {
        switch (status) {
            case com.inuker.bluetooth.library.Constants.STATUS_DEVICE_CONNECTED: return "Connected";
            case com.inuker.bluetooth.library.Constants.STATUS_DEVICE_CONNECTING: return "Connecting";
            case com.inuker.bluetooth.library.Constants.STATUS_DEVICE_DISCONNECTING: return "Disconnecting";
            case com.inuker.bluetooth.library.Constants.STATUS_DEVICE_DISCONNECTED: return "Disconnected";
            case com.inuker.bluetooth.library.Constants.STATUS_DEVICE_SERVICE_READY: return "Service Ready";
